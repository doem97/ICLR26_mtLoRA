#!/bin/bash
# Llama2-13B MMLU Ablation: +Block FFN +FGR g=512
# Dataset: Dolly-15K -> MMLU Evaluation
#
# Config: HydraLoRA + Block FFN + Fine-Grained Routing (g=512)
# Delta from 1_block_ffn: +enable_fine_grained_routing, +routing_group_size=512
...
OUTPUT_DIR="./output/llama13/3_fgr_g512"
LOG_DIR="./logs/llama13/3_fgr_g512"
