#!/bin/bash
# Llama2-13B MMLU Ablation: +Block FFN +FGR g=256
# Dataset: Dolly-15K -> MMLU Evaluation
#
# Config: HydraLoRA + Block FFN + Fine-Grained Routing (g=256)
# Delta from 1_block_ffn: +enable_fine_grained_routing, +routing_group_size=256
...
OUTPUT_DIR="./output/llama13/4_fgr_g256"
LOG_DIR="./logs/llama13/4_fgr_g256"
