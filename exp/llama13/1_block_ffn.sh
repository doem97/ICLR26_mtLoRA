#!/bin/bash
# Llama2-13B MMLU Ablation: +Block FFN
# Dataset: Dolly-15K -> MMLU Evaluation
#
# Config: HydraLoRA + Block FFN adapter
# Delta from baseline: +enable_block_adapter, +block_adapter_type=ffn
...
OUTPUT_DIR="./output/llama13/1_block_ffn"
LOG_DIR="./logs/llama13/1_block_ffn"

echo "========================================"
echo "[Llama2-13B] +Block FFN (MMLU)"
echo "========================================"
