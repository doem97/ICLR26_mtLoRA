#!/bin/bash
# Llama2-13B MMLU Ablation: Baseline (HydraLoRA)
# Dataset: Dolly-15K -> MMLU Evaluation
#
# Config: HydraLoRA on q_proj, v_proj with BLC
# This is the baseline for all 13B ablation experiments
...
# Baseline: No block adapter, no FGR
# ============================================================

OUTPUT_DIR="./output/llama13/0_baseline"
LOG_DIR="./logs/llama13/0_baseline"

echo "========================================"
echo "[Llama2-13B] Baseline: HydraLoRA (MMLU)"
echo "========================================"
