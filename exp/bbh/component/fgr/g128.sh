#!/bin/bash
# FGR Granularity Ablation: Component-Level, group_size=128
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# group_size=128 means 32 groups for 4096-dim output

set -e

echo "========================================"
echo "[2a] Component FGR: group_size=128"
echo "========================================"
echo "Adapter: HydraLoRA on q_proj, v_proj"
echo "Routing: 32 groups (4096/128)"
echo "========================================"
...
OUTPUT_DIR="./output/bbh/2_fgr_granularity/2a_component/g128"
LOG_DIR="./logs/bbh/2_fgr_granularity/2a_component/g128"
...
echo "  FGR: group_size=$ROUTING_GROUP_SIZE (num_groups=32)"

accelerate launch --num_processes $NPROC_PER_NODE --main_process_port 29624 \
    train.py \
