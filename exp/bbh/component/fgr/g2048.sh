#!/bin/bash
# FGR Granularity Ablation: Component-Level, group_size=2048
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# group_size=2048 means 2 groups for 4096-dim output

set -e

echo "========================================"
echo "[2a] Component FGR: group_size=2048"
echo "========================================"
echo "Adapter: HydraLoRA on q_proj, v_proj"
echo "Routing: 2 groups (4096/2048)"
echo "========================================"
...
OUTPUT_DIR="./output/bbh/2_fgr_granularity/2a_component/g2048"
LOG_DIR="./logs/bbh/2_fgr_granularity/2a_component/g2048"
...
echo "  FGR: group_size=$ROUTING_GROUP_SIZE (num_groups=2)"

accelerate launch --num_processes $NPROC_PER_NODE --main_process_port 29621 \
    train.py \
