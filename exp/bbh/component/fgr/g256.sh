#!/bin/bash
# FGR Granularity Ablation: Component-Level, group_size=256
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# group_size=256 means 16 groups for 4096-dim output

set -e

echo "========================================"
echo "[2a] Component FGR: group_size=256"
echo "========================================"
...
OUTPUT_DIR="./output/bbh/2_fgr_granularity/2a_component/g256"
LOG_DIR="./logs/bbh/2_fgr_granularity/2a_component/g256"
...
echo "  FGR: group_size=$ROUTING_GROUP_SIZE (num_groups=16)"

accelerate launch --num_processes $NPROC_PER_NODE --main_process_port 29623 \
    train.py \
