#!/bin/bash
# Spectral Frequency Ablation: 1x per epoch (step=500)
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# Triggers at midpoint (~step 500 out of 844)
# Fixed lambda=0.5

set -e

echo "========================================"
echo "[3b] Spectral Frequency: 1x/epoch"
echo "========================================"
echo "Lambda: 0.5 (fixed)"
echo "Frequency: step=500 -> triggers at 500 (midpoint)"
...
OUTPUT_DIR="./output/bbh/3_spectral/3b_frequency/1x_step500"
LOG_DIR="./logs/bbh/3_spectral/3b_frequency/1x_step500"
...
echo "  For 844 steps/epoch, triggers at: 500 (1x)"

accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29660 \
    train.py \
    --method mtlora \
