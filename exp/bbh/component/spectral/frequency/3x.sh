...
# 
# BBH: 844 steps/epoch → triggers at 250, 500, 750 (94 steps remaining)

set -e

echo "========================================"
echo "[3b] Spectral Frequency: 3x/epoch"
echo "========================================"
echo "Lambda: 0.5"
echo "Steps: 250 → triggers at 250, 500, 750"
echo "========================================"
...
OUTPUT_DIR="./output/bbh/3_spectral/lambda0.5_3x"
LOG_DIR="./logs/bbh/3_spectral/lambda0.5_3x"
...
SPECTRAL_REG_STEPS=250

mkdir -p "$OUTPUT_DIR"
mkdir -p "$LOG_DIR"

accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29700 \
    train.py \
    --method mtlora \
