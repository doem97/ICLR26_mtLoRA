#!/bin/bash
# Spectral Frequency Ablation: 5x per epoch, lambda=0.5
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# BBH: 844 steps/epoch → triggers at 150, 300, 450, 600, 750 (94 steps remaining)

set -e

echo "========================================"
echo "[3b] Spectral Frequency: 5x/epoch"
echo "========================================"
echo "Lambda: 0.5"
echo "Steps: 150 → triggers at 150, 300, 450, 600, 750"
echo "========================================"
...
OUTPUT_DIR="./output/bbh/3_spectral/lambda0.5_5x"
LOG_DIR="./logs/bbh/3_spectral/lambda0.5_5x"
...
SPECTRAL_REG_STEPS=150

mkdir -p "$OUTPUT_DIR"
mkdir -p "$LOG_DIR"

accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29702 \
    train.py \
    --method mtlora \
