#!/bin/bash
# Spectral Frequency Ablation: 2x per epoch (step=300)
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# Triggers at steps 300 and 600 (before end)
# Fixed lambda=0.5

set -e

echo "========================================"
echo "[3b] Spectral Frequency: 2x/epoch"
echo "========================================"
echo "Lambda: 0.5 (fixed)"
echo "Frequency: step=300 -> triggers at 300, 600 (2x)"
...
OUTPUT_DIR="./output/bbh/3_spectral/3b_frequency/2x_step300"
LOG_DIR="./logs/bbh/3_spectral/3b_frequency/2x_step300"
...
echo "  For 844 steps/epoch, triggers at: 300, 600 (2x, avoids 3rd at 900)"

accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29661 \
    train.py \
    --method mtlora \
