#!/bin/bash
# Spectral Lambda Ablation: lambda=0.25
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# Default spectral regularization (lambda=0.25), 1x per epoch

set -e

echo "========================================"
echo "[3a] Spectral Lambda: 0.25"
echo "========================================"
echo "Lambda: 0.25 (default)"
...
OUTPUT_DIR="./output/bbh/3_spectral/3a_lambda/lambda_0.25"
LOG_DIR="./logs/bbh/3_spectral/3a_lambda/lambda_0.25"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29651 \
    train.py \
    --method mtlora \
