#!/bin/bash
# Spectral Lambda Ablation: lambda=1.0
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# Strong spectral regularization (lambda=1.0), 1x per epoch

set -e

echo "========================================"
echo "[3a] Spectral Lambda: 1.0"
echo "========================================"
echo "Lambda: 1.0 (strong)"
...
OUTPUT_DIR="./output/bbh/3_spectral/3a_lambda/lambda_1.0"
LOG_DIR="./logs/bbh/3_spectral/3a_lambda/lambda_1.0"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29653 \
    train.py \
    --method mtlora \
