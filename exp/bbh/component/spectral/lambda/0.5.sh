#!/bin/bash
# Spectral Lambda Ablation: lambda=0.5
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# Moderate spectral regularization (lambda=0.5), 1x per epoch

set -e

echo "========================================"
echo "[3a] Spectral Lambda: 0.5"
echo "========================================"
echo "Lambda: 0.5 (moderate)"
...
OUTPUT_DIR="./output/bbh/3_spectral/3a_lambda/lambda_0.5"
LOG_DIR="./logs/bbh/3_spectral/3a_lambda/lambda_0.5"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29652 \
    train.py \
    --method mtlora \
