#!/bin/bash
# Block Position Ablation: Attention + FFN (Both)
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# Block adapter applied to both attention and FFN blocks

set -e

echo "========================================"
echo "[1c] Block Adapter: Attention + FFN"
echo "========================================"
echo "Position: Both attention and FFN blocks"
...
OUTPUT_DIR="./output/bbh/1_block_position/1c_attn_ffn"
LOG_DIR="./logs/bbh/1_block_position/1c_attn_ffn"
...
accelerate launch --num_processes $NPROC_PER_NODE --main_process_port 29612 \
    train.py \
