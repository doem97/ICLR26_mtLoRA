#!/bin/bash
# Block Position Ablation: Attention Only
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# Block adapter applied to attention blocks only (parallel to self-attention)

set -e

echo "========================================"
echo "[1a] Block Adapter: Attention Only"
echo "========================================"
echo "Position: Parallel to attention blocks"
...
OUTPUT_DIR="./output/bbh/1_block_position/1a_attn_only"
LOG_DIR="./logs/bbh/1_block_position/1a_attn_only"
...
accelerate launch --num_processes $NPROC_PER_NODE --main_process_port 29610 \
    train.py \
