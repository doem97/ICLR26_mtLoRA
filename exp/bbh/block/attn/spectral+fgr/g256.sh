...
OUTPUT_DIR="./output/bbh/block/attn/spectral+fgr/bbh/g256"
LOG_DIR="./logs/bbh/block/attn/spectral+fgr/bbh/g256"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29766 \
    train.py \
    --method mtlora \
