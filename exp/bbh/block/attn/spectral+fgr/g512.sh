...
OUTPUT_DIR="./output/bbh/block/attn/spectral+fgr/bbh/g512"
LOG_DIR="./logs/bbh/block/attn/spectral+fgr/bbh/g512"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29762 \
    train.py \
    --method mtlora \
