...
OUTPUT_DIR="./output/blockattn_reg/bbh/freq_1x"
LOG_DIR="./logs/blockattn_reg/bbh/freq_1x"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29754 \
    train.py \
    --method mtlora \
