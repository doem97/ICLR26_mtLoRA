#!/bin/bash
# Block Attention + Spectral: λ=0.5, 3x/epoch
...
SPECTRAL_REG_STEPS=180  # 3x/epoch (~844 steps total)
# ============================================================

OUTPUT_DIR="./output/blockattn_reg/bbh/freq_3x"
LOG_DIR="./logs/blockattn_reg/bbh/freq_3x"

echo "========================================"
echo "[Block Attn+Spectral] λ=$SPECTRAL_REG_LAMBDA, 3x/epoch"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29756 \
    train.py \
    --method mtlora \
