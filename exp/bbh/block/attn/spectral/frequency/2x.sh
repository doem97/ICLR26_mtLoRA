#!/bin/bash
# Block Attention + Spectral: λ=0.5, 2x/epoch
...
SPECTRAL_REG_STEPS=250  # 2x/epoch (~844 steps total)
# ============================================================

OUTPUT_DIR="./output/blockattn_reg/bbh/freq_2x"
LOG_DIR="./logs/blockattn_reg/bbh/freq_2x"

echo "========================================"
echo "[Block Attn+Spectral] λ=$SPECTRAL_REG_LAMBDA, 2x/epoch"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29755 \
    train.py \
    --method mtlora \
