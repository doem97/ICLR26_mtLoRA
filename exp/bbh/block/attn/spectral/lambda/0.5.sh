#!/bin/bash
# Block Attention + Spectral: λ=0.5, 1x/epoch
...
OUTPUT_DIR="./output/blockattn_reg/bbh/lambda_0.5"
LOG_DIR="./logs/blockattn_reg/bbh/lambda_0.5"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29752 \
    train.py \
    --method mtlora \
