#!/bin/bash
# Block Attention + Spectral: λ=1.0, 1x/epoch
...
OUTPUT_DIR="./output/blockattn_reg/bbh/lambda_1.0"
LOG_DIR="./logs/blockattn_reg/bbh/lambda_1.0"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29753 \
    train.py \
    --method mtlora \
