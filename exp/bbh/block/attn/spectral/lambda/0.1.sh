#!/bin/bash
# Block Attention + Spectral: λ=0.1, 1x/epoch
...
OUTPUT_DIR="./output/blockattn_reg/bbh/lambda_0.1"
LOG_DIR="./logs/blockattn_reg/bbh/lambda_0.1"

echo "========================================"
echo "[Block Attn+Spectral] λ=$SPECTRAL_REG_LAMBDA, 1x/epoch"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29751 \
    train.py \
    --method mtlora \
