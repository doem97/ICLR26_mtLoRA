#!/bin/bash
# Block FFN + Spectral Reg: Lambda=0.1
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# NOTE: Re-run after BLC fix (2024-11-29)
...
SPECTRAL_REG_STEPS=500  # 1x/epoch (~844 steps total)
# ============================================================

OUTPUT_DIR="./output/blockffn_reg/bbh/lambda/lambda_0.1"
LOG_DIR="./logs/blockffn_reg/bbh/lambda/lambda_0.1"

echo "========================================"
echo "[Block FFN + Spectral] Lambda=$SPECTRAL_REG_LAMBDA"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29803 \
    train.py \
    --method mtlora \
