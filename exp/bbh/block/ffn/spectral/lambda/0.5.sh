#!/bin/bash
# Block FFN + Spectral Reg: Lambda=0.5
...
OUTPUT_DIR="./output/blockffn_reg/bbh/lambda/lambda_0.5"
LOG_DIR="./logs/blockffn_reg/bbh/lambda/lambda_0.5"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29801 \
    train.py \
    --method mtlora \
