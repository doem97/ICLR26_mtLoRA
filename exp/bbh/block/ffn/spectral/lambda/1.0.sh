#!/bin/bash
# Block FFN + Spectral Reg: Lambda=1.0
...
OUTPUT_DIR="./output/blockffn_reg/bbh/lambda/lambda_1.0"
LOG_DIR="./logs/blockffn_reg/bbh/lambda/lambda_1.0"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29802 \
    train.py \
    --method mtlora \
