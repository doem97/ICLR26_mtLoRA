#!/bin/bash
# Block FFN + Spectral Reg: Frequency=2x/epoch
...
SPECTRAL_REG_STEPS=300  # 2x/epoch (~844 steps total, triggers at 300, 600)
# ============================================================

OUTPUT_DIR="./output/blockffn_reg/bbh/frequency/2x"
LOG_DIR="./logs/blockffn_reg/bbh/frequency/2x"

echo "========================================"
echo "[Block FFN + Spectral] Frequency=2x/epoch"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29811 \
    train.py \
    --method mtlora \
