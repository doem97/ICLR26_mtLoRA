#!/bin/bash
# Block FFN + Spectral Reg: Frequency=1x/epoch
...
OUTPUT_DIR="./output/blockffn_reg/bbh/frequency/1x"
LOG_DIR="./logs/blockffn_reg/bbh/frequency/1x"

echo "========================================"
echo "[Block FFN + Spectral] Frequency=1x/epoch"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29810 \
    train.py \
    --method mtlora \
