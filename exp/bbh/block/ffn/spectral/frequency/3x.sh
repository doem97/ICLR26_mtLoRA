#!/bin/bash
# Block FFN + Spectral Reg: Frequency=3x/epoch
...
SPECTRAL_REG_STEPS=250  # 3x/epoch (~844 steps total, triggers at 250, 500, 750)
# ============================================================

OUTPUT_DIR="./output/blockffn_reg/bbh/frequency/3x"
LOG_DIR="./logs/blockffn_reg/bbh/frequency/3x"

echo "========================================"
echo "[Block FFN + Spectral] Frequency=3x/epoch"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29812 \
    train.py \
    --method mtlora \
