...
OUTPUT_DIR="./output/bbh_reg_fgr/g2048"
LOG_DIR="./logs/bbh_reg_fgr/g2048"

echo "========================================"
echo "[Block FFN + Spectral + FGR] g=$ROUTING_2048"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29706 \
    train.py \
    --method mtlora \
    ...
    --routing_group_size $ROUTING_2048
