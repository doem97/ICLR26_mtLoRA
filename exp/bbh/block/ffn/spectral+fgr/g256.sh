...
OUTPUT_DIR="./output/bbh_reg_fgr/g256"
LOG_DIR="./logs/bbh_reg_fgr/g256"

echo "========================================"
echo "[Block FFN + Spectral + FGR] g=$ROUTING_256"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29707 \
    train.py \
    --method mtlora \
    ...
    --routing_group_size $ROUTING_256
