#!/bin/bash
# Block FFN + Spectral + FGR g=4096 (scalar routing)
...
OUTPUT_DIR="./output/bbh_reg_fgr/g4096"
LOG_DIR="./logs/bbh_reg_fgr/g4096"

echo "========================================"
echo "[Block FFN + Spectral + FGR] g=$ROUTING_GROUP_SIZE"
echo "========================================"
...
accelerate launch --multi_gpu --num_processes $NPROC_PER_NODE --main_process_port 29701 \
    train.py \
    --method mtlora \
