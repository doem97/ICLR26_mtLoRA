#!/bin/bash
# FGR Granularity Ablation: Block-Level, group_size=512
# Dataset: Flan V2 Subset -> BBH Evaluation

set -e

echo "========================================"
echo "[2b] Block FGR: group_size=512"
echo "========================================"
...
OUTPUT_DIR="./output/bbh/2_fgr_granularity/2b_block/g512"
LOG_DIR="./logs/bbh/2_fgr_granularity/2b_block/g512"
...
accelerate launch --num_processes $NPROC_PER_NODE --main_process_port 29632 \
    train.py \
