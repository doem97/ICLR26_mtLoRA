#!/bin/bash
# FGR Granularity Ablation: Block-Level, group_size=4096 (Scalar)
# Dataset: Flan V2 Subset -> BBH Evaluation
# 
# Block adapter on FFN with group_size=4096 (1 group = scalar routing)

set -e

echo "========================================"
echo "[2b] Block FGR: group_size=4096 (Scalar)"
echo "========================================"
...
OUTPUT_DIR="./output/bbh/2_fgr_granularity/2b_block/g4096_scalar"
LOG_DIR="./logs/bbh/2_fgr_granularity/2b_block/g4096_scalar"
...
accelerate launch --num_processes $NPROC_PER_NODE --main_process_port 29630 \
    train.py \
