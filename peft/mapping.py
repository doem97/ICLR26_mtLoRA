...
from .tuners.mmoelora import MMOELoraConfig
from .tuners.mmoeloraS import MMOELoraConfigS
from .tuners.adalora import AdaLoraConfig
...
PEFT_TYPE_TO_CONFIG_MAPPING = {
    ...
    "LORA": LoraConfig,
    "HYDRALORA": LoraConfig,  # HydraLoRA uses LoraConfig with lora_nums > 1
...
def _prepare_prompt_learning_config(peft_config, model_config):
    ...
    if getattr(peft_config, "encoder_hidden_size", None) is None:
        peft_config.encoder_hidden_size = token_dim
