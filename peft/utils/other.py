...
# Default target modules mapping for MMOELORA
# Maps model types to their default attention/FFN modules
...
# Default target modules mapping for AdaLoRA
# AdaLoRA uses the same target modules as standard LoRA
...
def _get_submodules(model, key):
    """Get parent module, target module, and target name from a dotted key path"""
